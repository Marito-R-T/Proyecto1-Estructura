...
OBJECTFILES= \
	${OBJECTDIR}/Accion.o \
	${OBJECTDIR}/Analizador.o \
	${OBJECTDIR}/Arbol.o \
	${OBJECTDIR}/BaseDatos.o \
	${OBJECTDIR}/Char.o \
	${OBJECTDIR}/Dato.o \
	${OBJECTDIR}/Decimal.o \
	${OBJECTDIR}/Entero.o \
...
${OBJECTDIR}/Accion.o: Accion.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Accion.o Accion.cpp

${OBJECTDIR}/Analizador.o: Analizador.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Analizador.o Analizador.cpp
...
${OBJECTDIR}/BaseDatos.o: BaseDatos.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BaseDatos.o BaseDatos.cpp

${OBJECTDIR}/Char.o: Char.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Char.o Char.cpp

${OBJECTDIR}/Dato.o: Dato.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Dato.o Dato.cpp

${OBJECTDIR}/Decimal.o: Decimal.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Decimal.o Decimal.cpp
